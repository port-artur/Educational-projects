            ...
            VStack {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Text("Данные о погоде")
                        .bold().padding(.bottom)
                    HStack {
                        WeatherRow(logo: "thermometer", name: "Мин.темп", value: (weather.main.tempMin.roundDouble() + "º"))
                        Spacer()
                        WeatherRow(logo: "thermometer.sun", name: "Макс.темп", value: (weather.main.tempMax.roundDouble() + "º"))
                    }
                    HStack {
...
struct WratherView_Previews: PreviewProvider {
